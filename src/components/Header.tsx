...
const Header = () => {
    ...
    const routes = [
        ...
        { name: 'stats', path: '/', sectionId: 'stats' },
        { name: 'about-me', path: '/', sectionId: 'about-me' },
                            ...
                            <div className="absolute top-full right-0 mt-2 bg-background border border-gray-200 rounded-md shadow-lg z-50 min-w-[120px]">
                                {languages.map((language) => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 transition-colors ${currentLanguage === language.code ? 'text-primary font-semibold' : ''
                                            }`}
                                    >
                                        {language.name}
                                    </button>
                                ...
                                <div className="bg-gray-50">
                                    {languages.map((language) => (
                                        <button
                                            ...
                                            className={`w-full text-left px-8 py-3 text-base hover:bg-gray-100 transition-colors ${currentLanguage === language.code ? 'text-primary font-semibold' : ''
                                                }`}
                                        >
                                            {language.name}
                                        </button>
